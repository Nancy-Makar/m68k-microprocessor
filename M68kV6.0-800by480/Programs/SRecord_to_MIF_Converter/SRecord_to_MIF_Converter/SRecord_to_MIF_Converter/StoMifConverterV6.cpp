...
int main(int argc, char *argv[])
{
  ...
  if((SourceFilePtr =  fopen("C:\\ide68kproject\\asn1final\\asn1fix\\tryf2\\memtest.hex", "r")) == NULL)	{
	...
	if((DestFilePtr = fopen("C:\\ide68kproject\\asn1final\\asn1fix\\tryf2\\mif\\memtest.mif","w")) == NULL)	{
