...
# ACDS 18.1 625 win32 2023.03.09.23:44:35
...
# ----------------------------------------
# If ClockGen is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockGen.vho"
fi
